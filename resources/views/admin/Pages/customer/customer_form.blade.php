    ...
    <div class="row">
        ...
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="box">
                ...
                <!-- form start -->
                {{Form::open(array('route' => 'customerSave', 'files' => true)) }}
                <div class="row">
                    <div class="col-md-10">
                        <div class="box-body">
                            <div class="row form-group">
                                ...
                                <div class="col-sm-8">
                                    {{Form::text('customer_name', '', $attributes = array('class' => 'form-control', 'placeholder' => 'NT APP'))}}
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-8">
                                    {{Form::text('customer_description', '', $attributes = array('class' => 'form-control', 'placeholder' => 'Customer Description'))}}
