    ...
    <div class="row">
        ...
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="box">
                ...
                <!-- form start -->
                {{Form::open(array('route' => 'brandEditSave', 'files' => true)) }}
                <div class="row">
                    <div class="col-md-10">
                        <div class="box-body">
                            <div class="row form-group">
                                ...
                                <div class="col-sm-8">
                                    {{Form::hidden('id', $value = $brand_info->id)}}
                                    {{Form::text('brand_name', $value = $brand_info->Brand_Name, $attributes = array('class' => 'form-control', 'placeholder' => 'NT APP'))}}
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-8">
                                    {{Form::text('brand_description', $value = $brand_info->Brand_Description, $attributes = array('class' => 'form-control', 'placeholder' => 'Brand Description'))}}
